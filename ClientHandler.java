...
public class ClientHandler implements Runnable{
    ...
    public ClientHandler(Socket socket, Reservation reservation, Library Library) {
        this.socket = socket;
    ...
    private void handleLibraries(BufferedReader in, PrintWriter out) throws IOException {   
        ArrayList<String> libraries = reservation.getLibrary().getLibraries();
    ...
    private void handleTopic(BufferedReader in, PrintWriter out) throws IOException {
        ...
        ArrayList<String> topics = reservation.getLibrary().getTopics(libNum);
    ...
    private void handleBooks(BufferedReader in, PrintWriter out) throws IOException {
        ...
        ArrayList<String> books = reservation.getLibrary().getBooks(libNum, topicNum);
    ...
    private void cancel(BufferedReader in, PrintWriter out) throws IOException {
    System.out.println("Enter library number:");
    int libNum = Integer.parseInt(in.readLine()) - 1;
    ...
    String result = reservation.cancel(libNum, topicNum, bookName, username);
    System.out.println(result);
}
